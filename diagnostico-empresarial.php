					...
					<div class="flex flex-wrap justify-between -mx-4">
						...
						<div class="relative w-full px-4 pb-8 md:pb-0 md:w-1/2">
							...
							<div class="relative overflow-hidden block w-full h-0 mb:pb-0 pb-[60%] md:h-full z-3 wow fadeInUp">
								<img src="assets/img/solucao-01.jpg" width="744" height="519" alt="Blocos de peças conectados" class="absolute top-0 left-0 w-full h-full object-cover">
							</div>
							...
							<div class="relative z-2 pt-12 sm:pt-14 lg:pt-20 pb-8 sm:pb-12 lg:pb-16 text-white">
								...
								<div class="flex flex-wrap justify-between -mx-4 text-medium">
									...
									<div class="relative w-full px-4 md:w-1/2">
										...
										<a href="contato.php" class="inline-block px-6 py-3 font-semibold text-white uppercase transition-all duration-300 bg-transparent border border-white sm:px-8 sm:py-4 text-medium hover:bg-white hover:text-blue-medium wow fadeInUp">
											Entre em contato
										</a>
									...
									<div class="relative w-full px-4 md:w-1/2 md:mt-0 mt-12">
										...
										<div class="relative overflow-hidden block w-[90%] md:w-[80%] h-0 mb:pb-0 pb-[60%] md:h-full z-3 wow fadeInUp">
											<img src="assets/img/solucao-01-2.jpg" width="744" height="519" alt="Pessoas conversando e comparando gráficos" class="absolute top-0 left-0 w-full h-full object-cover">
										</div>
