					...
					<div class="flex flex-wrap justify-between -mx-4">
						<div class="w-full px-4">
							...
							<div class="block lg:mt-20 lg:pt-20 md:mt-14 md:pt-14 sm:mt-12 sm:pt-10 mt-10 pt-8 border-t border-blue-light wow fadeIn">
								...
								<a href="contato.php" class="inline-block px-6 py-3 font-semibold uppercase transition-all duration-300 bg-transparent border border-gray-700 sm:px-8 sm:py-4 text-medium hover:bg-blue-dark hover:text-white hover:border-blue-dark">
									Entre em contato
								</a>
