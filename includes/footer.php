                ...
                <ul class="flex gap-x-2">
                    ...
                    <li>
                        <a href="https://www.facebook.com/Conwert-Gest%C3%A3o-Empresarial-100347276020103" target="_blank" class="flex items-center justify-center w-9 h-9 group">
                            <img src="assets/svg/facebook.svg" alt="Facebook" class="w-[60%] h-[60%] svg text-white group-hover:opacity-70 transition-opacity duration-300">
                        </a>
                    </li>

                    <li>
                        <a href="https://www.instagram.com/conwert.gestao/" target="_blank" class="flex items-center justify-center w-9 h-9 group">
                            <img src="assets/svg/instagram.svg" alt="Instagram" class="w-[60%] h-[60%] svg text-white group-hover:opacity-70 transition-opacity duration-300">
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="https://www.linkedin.com/company/conwert-gest%C3%A3o-empresarial/" target="_blank" class="flex items-center justify-center w-9 h-9 group">
                            <img src="assets/svg/linkedin.svg" alt="Linkedin" class="w-[60%] h-[60%] svg text-white group-hover:opacity-70 transition-opacity duration-300">
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="https://www.youtube.com/channel/UCln1EJO855OPfw--_EGgamg" target="_blank" class="flex items-center justify-center w-9 h-9 group">
                            <img src="assets/svg/youtube.svg" alt="Youtube" class="w-[60%] h-[60%] svg text-white group-hover:opacity-70 transition-opacity duration-300">
                        </a>
                    </li>
