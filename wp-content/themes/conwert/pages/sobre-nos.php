	...
	<div class="container-wrapper">
		<div class="flex flex-wrap justify-between -mx-4">
			<div class="w-full px-4">
				...
				<div class="desc text-medium block mt-4 sm:mt-6 md:mt-10 lg:mt-16 mb-12 sm:mb-20 md:mb-32 text-blue-dark wow fadeIn">
				...
				<div class="flex flex-wrap justify-start gap-10 wow fadeIn mb-10 sm:mb-12 md:mb-16 lg:mb-20">
