<a href="<?=get_site_url()?>/gestao-de-reestruturacao" class="box wow fadeInUp">

    <img src="<?=get_site_url()?>/wp-content/themes/conwert/assets/svg/icon-02.svg" alt="Gestão de reestruturação" class="icon">
